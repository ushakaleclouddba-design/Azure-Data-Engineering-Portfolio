...
$OutputXlsx = "Migration_Assessment_Report_$(Get-Date -Format 'yyyy-MM-dd').xlsx"
...
$es.Column(4).Width = 10
$es.Column(5).Width = 12
$es.Column(6).Width = 60   # Top issue
...
# EPPlus MoveToStart pushes a sheet to position 0. Calling them in REVERSE order
# of the desired final order leaves them in the right sequence.
